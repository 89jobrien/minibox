...
- **changed-files-secret-scan** — `/Users/joe/dev/minibox/.claude/skills/changed-files-secret-scan`
  - Scan only dirty-tree files for secrets before staging or committing.
- **docs** — `/Users/joe/dev/minibox/.claude/skills/docs`
  - Maintain source-backed documentation, provenance, links, and canonical homes.
- **minibox** — `/Users/joe/dev/minibox/.claude/skills/minibox`
  - Minibox development, protocol, performance, and release guidance.
- **minibox-rustqual-fixloop** — `/Users/joe/dev/minibox/.agents/skills/minibox-rustqual-fixloop`
  - Improve rustqual findings while preserving architecture and behavior.
- **run-minibox** — `/Users/joe/dev/minibox/.claude/skills/run-minibox`
  - Build and drive an isolated minibox daemon/CLI lifecycle.
- **whatidid** — `/Users/joe/dev/minibox/.claude/skills/whatidid`
  - Generate daily activity reports from Claude Code session data.
- **wave-integration** — `/Users/joe/dev/minibox/.claude/skills/wave-integration`
  - Integrate parallel branches sequentially into `develop`.
