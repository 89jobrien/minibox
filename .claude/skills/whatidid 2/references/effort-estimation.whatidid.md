...
the effort estimates in _What I Did (Copilot)_. Every design decision traces to a
...
- **Lavazza et al. (2024)** analysed hundreds of projects and found that simpler
  ...
  function-point analysis — and _all_ methods underestimated effort on highly
  complex projects.
...
- **Hao et al. (2023)** measured actual brain activity (EEG) and eye-tracking of
  ...
  Halstead volume) often _mis-predict_ how hard code is for humans to understand.
...
complexity. This is _not_ part of the deterministic formula (which uses turns,
...
the _qualitative_ difference: a session with 10 edits per file is fundamentally
...
standalone effort predictor. However, as a _multiplier_ applied to an
...
what the work _meant_, not just how many artifacts it produced.
...
8. Morcov, S., Pintelon, L., & Kusters, R. (2020). "Definitions, Characteristics
   and Measures of IT Project Complexity." _International Journal of Information
   Technology Project Management._
...
12. Vaithilingam, P., Zhang, T., & Glassman, E. L. (2022). "Expectation vs.
    ...
    Large Language Models." _CHI EA '22._
...
_This methodology is open source and evolving. Contributions, corrections, and
calibration data are welcome at
[github.com/microsoft/What-I-Did-Copilot](https://github.com/microsoft/What-I-Did-Copilot)._
