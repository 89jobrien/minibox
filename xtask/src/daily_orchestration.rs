...
/// Runs Claude with either the local all-repository prompt or the CI-safe single-repository prompt.
///
/// Dry-run mode prints the resolved invocation and CI policy without launching Claude.
