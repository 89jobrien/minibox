...
**Date:** 2026-03-17
**Status:** Design
**Scope:** `minibox-lib/src/adapters/`, `minibox-lib/src/domain.rs`
...
Two `macro_rules!` macros in `minibox-lib/src/adapters/mod.rs`, exported from the crate root.
...
- Macro definitions: `minibox-lib/src/macros.rs` (new file), re-exported from `lib.rs` via `pub use macros::*`
