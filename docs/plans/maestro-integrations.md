...
Minibox has a clean Docker Hub v2 client in minibox/src/image/registry.rs. Maestro currently delegates image pulls to Docker daemon. On a minibox provider path, you'd reuse minibox's registry client directly.
