...
| `crates/minibox-lib/tests/proptest_suite.rs` | Modify | Add cgroup bounds tests (2, Linux-gated) |
...
**Files:**
- Modify: `crates/minibox-lib/tests/proptest_suite.rs`
...
Open `crates/minibox-lib/tests/proptest_suite.rs` and append at the end:
...
Expected: existing minibox-lib proptest tests still pass; `cgroup_props` module is compiled away on macOS — no failures.
