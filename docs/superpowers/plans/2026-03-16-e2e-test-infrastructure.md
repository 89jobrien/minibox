...
In `crates/minibox-lib/src/lib.rs`, add after the existing modules:
...
Run: `cargo test -p minibox-lib preflight`
Expected: 3 tests pass

- [ ] **Step 4: Commit**

```bash
git add crates/minibox-lib/src/preflight.rs crates/minibox-lib/src/lib.rs
