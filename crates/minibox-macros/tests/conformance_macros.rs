...
#[test]
fn denormalize_digest_restores_colon() {
    assert_eq!(denormalize_digest!("sha256_abc123"), "sha256:abc123");
}

#[test]
fn normalize_digest_denormalize_digest_roundtrip() {
