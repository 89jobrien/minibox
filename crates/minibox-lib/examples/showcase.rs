...
//!
//! Usage:
//!   cargo run --release --example showcase -p minibox-lib
//!   cargo run --release --example showcase -p minibox-lib -- --run /path/to/minibox
//!   cargo run --release --example showcase -p minibox-lib -- --run ./target/release/minibox --cleanup
