...
crate::conformance_test! {
    name: "spawn_returns_nonzero_pid",
    adapter: "runtime",
    category: Unit,
    |ctx| {
...
crate::conformance_test! {
    name: "successive_spawns_different_pids",
    adapter: "runtime",
    category: Unit,
    |ctx| {
        let runtime = MockRuntime::new();
...
crate::conformance_test! {
    name: "spawn_failure_increments_count",
    adapter: "runtime",
    category: EdgeCase,
    |ctx| {
        let runtime = MockRuntime::new().with_spawn_failure();
...
crate::conformance_test! {
    name: "capabilities_returns_struct",
    adapter: "runtime",
    category: Unit,
    |ctx| {
        let runtime = MockRuntime::new();
...
crate::conformance_test! {
    name: "sync_async_failure_consistency",
    adapter: "runtime",
    category: EdgeCase,
    |ctx| {
        let runtime = MockRuntime::new().with_spawn_failure();
