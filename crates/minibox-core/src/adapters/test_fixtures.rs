...
//! to simplify test setup across the mbx test suite.
//!
//! # Usage
//!
//! ```rust,ignore
//! use mbx::adapters::test_fixtures::{MockAdapterBuilder, TempContainerFixture};
//!
//! #[tokio::test]
...
mod tests {
    ...
    async fn test_builder_injects_pull_failure() {
        ...
        let result = adapters.registry.pull_image(&image_ref).await;
